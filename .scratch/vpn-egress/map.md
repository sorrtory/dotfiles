...
Tickets **01–11, 13 and 14** are resolved. Ticket 06 uses the shared
...
points. Ticket 11 records daily-host suspend and observed Wi-Fi changes with
the TUN both down and up. Ticket 12 removed the approved in-repo legacy path
and per-device ciphertext; the outer legacy repositories are out of scope.
