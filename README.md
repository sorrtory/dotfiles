...
| 09  | `apparmor`        | On Ubuntu's restricted user namespaces, installs the exact-path allowances Vesktop and `vpn` need, generated by phase 04. Does nothing elsewhere.                             | sudo password                                                            |
